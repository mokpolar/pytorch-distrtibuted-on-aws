...
dist_backend = 'nccl' # DISTRIBUTED BACKEND는 NCCL 사용

# Url used to setup distributed training
dist_url = "tcp://171.31.35.170:8888" # EC2 Private IP 로 변경
...
# v1 - init with url
dist.init_process_group(backend=dist_backend, init_method=dist_url, rank=int(sys.argv[1]), world_size=world_size) # 여기 RANK 랑 WORLD_SIZE 지정.
# v2 - init with file
